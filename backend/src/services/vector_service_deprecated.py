...
This is the old vector service implementation.
Use vector_service.py (the improved version) instead.
...
class VectorService:
    ...
    def _initialize_client(self):
        ...
        logger.info(f"🔍 Initializing Qdrant - URL: {qdrant_url[:30]}... API Key: {'Set' if qdrant_api_key else 'Not set'}")
